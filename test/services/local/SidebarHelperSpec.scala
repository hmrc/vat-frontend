  ...
  "The sidebar" when {
    "there is a user" should {
      ...
      "show the 'Online seminars' link" in {
        ...
        assertLinkById(
          asDocument(view),
          "online-seminars",
          "Online seminars to learn about tax (opens in a new window or tab)",
    ...
    "the user files anually" should {
      "show the filing period of the user" in {
        ...
        assertLinkById(
          doc,
          "leave-annual-scheme",
          "Leave the VAT annual accounting scheme (opens in a new window or tab)",
    ...
    "the user files monthly" should {
      "show the filing period of the user" in {
        ...
        assertLinkById(
          doc,
          "change-to-quarterly",
          "Change to quarterly filing (opens in a new window or tab)",
        ...
        assertLinkById(
          doc,
          "change-to-annual",
          "Change to annual filing (opens in a new window or tab)",
    ...
    def validateLinksForQuarterlyFiling(doc: Document) = {
      assertLinkById(
        doc,
        "change-to-monthly",
        "File monthly or change filing months (opens in a new window or tab)",
        s"http://localhost:8080/portal/vat-variations/org/$testVrn/introduction?lang=eng",
