...
class FrontendAppConfig @Inject()(val runModeConfiguration: Configuration,
  ...
  private lazy val tarHost: String = runModeConfiguration.getOptional[String]("microservice.services.tax-account-router-frontend.host").getOrElse("")
  ...
  def getTarUrl: String = tarHost + loadConfig(s"microservice.services.tax-account-router-frontend.url")
